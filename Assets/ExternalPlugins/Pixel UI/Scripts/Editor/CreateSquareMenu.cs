/******************************************************************************************
 * Name: CreateSquareMenu.cs
 * Created by: Jeremy Voss
 * Created on: 01/15/2019
 * Last Modified: 02/04/2019
 * Description:
 * Creates a menu for adding Square themed prefabs to the scene.
 ******************************************************************************************/
using UnityEngine;
using UnityEditor;
using System;
...
{
    public class CreateSquareMenu : MonoBehaviour
    {
        #region Constants

        const string skinName = "Square";
        const string skinPath = "Prefabs/Square/";
