...
public class SubSceneUnLoadSystem : SystemBase {
    ...
    protected override void OnUpdate() {
        ...
        Entities
            ...
            .ForEach((Entity entity, ref SubSceneUnLoadComponent subSceneControl) => {
            ...
            .ForEach((Entity subSceneEntity, in SceneSectionData sectionData) => {
                foreach (var id in requestLoadIds) {
                    ...
                    if (checkSubScene.SceneGUID == sectionData.SceneGUID) {
                        ...
                        EntityManager.RemoveComponent<RequestSceneLoaded>(subSceneEntity);
                        return;
                    }
                }
            })
